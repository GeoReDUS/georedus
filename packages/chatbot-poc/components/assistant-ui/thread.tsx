    ...
    <div className="aui-thread-welcome-suggestions grid w-full gap-2 @md:grid-cols-2">
      {[
        ...
        },
        {
          ...
          label: "usa V01032+V01033 sobre V0001",
          action:
            "Gere um SQL no modelo indicado que calcule % de 5–14 anos",
        },
        {
          title: "SQL: densidade 5–14 anos (km²)",
          label: "contagem por área do setor",
          action:
            "Gere um SQL que calcule map_color_value como densidade 5–14 anos (km²)",
        },
        // {
