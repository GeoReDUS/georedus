export const PROMPT = `Você é um bot auxiliando um usuário 
...
DESCRIBE SELECT * FROM read_parquet('35census_tract_2020_simplified.parquet');
┌──────────────────┬──────────────────────┬─────────┬───┬─────────┬─────────┐
...
WITH base AS (
  ...
  FROM
    'http://localhost:3000/censo/35census_tract_2020_simplified.parquet' AS m
  JOIN
    'http://localhost:3000/censo/2022_tracts_Basico_v0.5.0.parquet' AS b
...
FROM
  'http://localhost:3000/censo/35census_tract_2020_simplified.parquet'
  AS m
JOIN
  read_csv(
