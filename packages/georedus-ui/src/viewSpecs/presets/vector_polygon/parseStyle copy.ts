...
type VectorPolygonCategoricalMulti = {
  dataType?: 'categorical'
  categoryKey: string
  colorScheme:
...
type VectorPolygonCategorical =
  ...
  | VectorPolygonCategoricalMulti
type StyleSpec = VectorPolygonCategorical | VectorPolygonSequential

type StyleSpecInput = StyleSpec | string

const style: StyleSpec = {
  colorScheme: 'schemeGeoReDUSVectorPolygon',
  categoryKey: 'zoneamento',
}
